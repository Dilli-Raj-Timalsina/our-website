                        ...
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    Build nailing brand in this compitetive market with
                                ...
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Establish a compelling company image in the
                                            eyes of your customers through strategic
                                            branding efforts.
                                        </dd>
                                    </div>
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Create unique and memorable graphic elements,
                                            including logos, banners, posters, and
                                            leaflets .
                                        </dd>
                                    </div>
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Craft bespoke designs that reflect your
                                            brand's personality and requirements, ensuring
                                            consistency and impact across all sizes and
                                            events.
                                        </dd>
                                    </div>
                                </dl>
