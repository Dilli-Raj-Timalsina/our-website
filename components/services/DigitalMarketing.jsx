            ...
            <section className="overflow-hidden bg-white py-8 sm:py-16">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                                    Ditital Marketing Solution
                                </p>
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    We will grow your business in leaps and bounds with
                                ...
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Elevate your online presence and customer
                                            engagement through targeted digital marketing
                                            strategies.
                                        </dd>
                                    </div>
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Enhance your visibility and reach a wider
                                            audience by optimizing your website,
                                    ...
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900">
                                            ...
                                            Tailored Revenue Maximization
                                        </dt>
                                        <dd className="inline">
                                            Tailor-made solutions to boost your revenue by
                                            fine-tuning your products and services, while
                        ...
                        <img
                            src="https://media.istockphoto.com/id/1443560890/photo/digital-marketing-business-technology-concept-website-advertisement-email-social-media.jpg?s=1024x1024&w=is&k=20&c=N65ufLsxvt6b5XaKSitmu09gDUhEitFqfM4cWG7CTMk="
