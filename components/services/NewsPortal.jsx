                        ...
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                                    News Portals Website
                                </p>
                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    Engage global audiences while retaining control with
                                    intuitive tools and customizable permissions .
                                </p>
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Delivering interactive, high-quality mobile
                                            apps for iPhone (iOS) and Android devices .
                                        </dd>
                                    </div>
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900">
                                            ...
                                            Expert News Portal Design
                                        </dt>
                                        <dd className="inline">
                                            Crafted by a decade-long expert, our news
                                            portals engage global audiences with
                                            intelligent tracking tools and an intuitive
                                    ...
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline">
                                            Tailored permission levels enable multiple
                                            users to swiftly create, manage, and modify
                                            news articles across diverse categories.
                                        </dd>
                                    </div>
                                </dl>
                            </div>
